...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		//System.out.println(countryMarkers.get(0).getProperties()); //to see properties of a country
		//System.out.println(earthqukes.get(0).getProperties()); //to see properties of a earthquakes
	    ...
	    //printQuakes(); //print info about quakes in the countries
